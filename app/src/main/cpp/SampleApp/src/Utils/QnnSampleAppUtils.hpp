...
ReadInputListRetType_t readInputList(const std::string& inputFileListPath);
...
ReadInputListsRetType_t readInputLists(const std::vector<std::string>& inputFileListPath);

std::unordered_map<std::string, uint32_t> extractInputNameIndices(const std::string &inputLine,
                                                                  const std::string &separator);

std::string sanitizeTensorName(const std::string& name);
