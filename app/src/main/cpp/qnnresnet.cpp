...
Java_com_example_qnnresnet_MainActivity_setPaths(JNIEnv* env, jobject /* this */,
                                                 jstring working_dir, jstring model_path, jstring runtime_path)
{
...
Java_com_example_qnnresnet_MainActivity_qnnLoadLibsAndCreateApp([[maybe_unused]] JNIEnv* env, jobject /* this */) {
    ...
    app = std::make_unique<app_t> (qnn_func_ptrs, g_working_dir + "input", "",
